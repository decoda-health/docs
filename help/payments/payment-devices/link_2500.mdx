...
<p align="center">
  <img
    src="/help/payments/payment-devices/images/link_2500.png"
    alt="link_2500"
    width="250"
  />
</p>
...
<Steps>
  <Step title="Power on the device">
    ...
    <p align="center">
      <img
        src="/help/payments/payment-devices/images/link_2500_button.png"
        alt="link_2500"
        width="250"
      />
    </p>
...
<Step title="Set Communication Type">
  Using the **F2** and **F3** function keys to scroll, select option `1 -
  Communication Type` then within that menu, select option `4 - WIFI`. Navigate
  back to the Admin Menu using the **Yellow back button**.
</Step>

<Step title="Configure WIFI Parameters">
  In the Admin Menu, select option `2 - WIFI Parameters`, then in that menu,
  select option `2 - Scan Networks` to search for networks nearby. Once the scan
  is completed, you will see a list of networks available.
</Step>
...
## Resetting the Device if Disconnected from WiFi

If your Link/2500 device becomes disconnected from WiFi, you can reset it by pressing the **Yellow** button and the pound sign `#` button at the same time. This will reset the device and allow it to reconnect to WiFi.
