...
If you don't have an API key, contact [Decoda Health Support](mailto:founders@decodahealth.com) to request access.
...
- Email: [founders@decodahealth.com](mailto:founders@decodahealth.com)
