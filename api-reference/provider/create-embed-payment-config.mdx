...
You must create the charge first via the [Create Charge](/api-reference/provider/create-charge) or [Convert Cart to Charge](/api-reference/provider/convert-cart-to-charge) API. See [Embed payment with itemized charges](/guides/embed-payment-itemized-charges) for the full flow.
