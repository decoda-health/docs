---
title: 'Payment Embed: Itemized Charges'
description: 'Create a charge with line items via the API, then collect payment through the embedded payment component.'
---
