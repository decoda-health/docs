---
title: 'Store Details Embed: Save Payment Methods'
description: 'Embed a form to collect and save a patient''s card or bank account details without charging them.'
---
...
You can also generate embed code from **Settings > Developers > Embedded Payment Components**. Open the **Store Details** tab, where you can:
