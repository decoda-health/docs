...
To start receiving events through a webhook, you must [create a new Webhook](/api-reference/external/webhook-create) for the `Tenant` you wish to subscribe to.
