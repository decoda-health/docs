...
A group of staff members who can answer incoming calls on a phone number. During scheduled hours, calls are distributed based on the selected strategy (simultaneous or round-robin). [More about Ring Groups →](/modules/phone-numbers/ring-groups)
