...
**Purpose:** View provider shifts for the previous week.
...
**Purpose:** View provider shifts for the upcoming week.
...
**Purpose:** Quickly navigate to a particular week by selecting a date.
...
**Purpose:** Show only providers who work at specific locations.
...
**Purpose:** Show only specific providers' shifts.
...
**Purpose:** Include or exclude AI assistants from the shift calendar.
...
**Purpose:** Show providers who have time blocks but no regular shifts scheduled.
...
**Purpose:** Create a new work shift for a provider.
...
**Purpose:** Block out time when a provider is unavailable for appointments.
...
**Purpose:** Mark a day as a holiday when the practice is closed.
...
**Purpose:** Remove previously added holidays.
...
**Purpose:** Modify an existing shift's time, date, or other details.
...
**Purpose:** Remove a shift from the calendar.
...
**Purpose:** Identify which shifts are part of a recurring schedule.
