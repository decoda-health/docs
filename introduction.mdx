...
- Assign every patient bill to a unique ruleset defining the cadence and medium of each touchpoint. For example, send a text on day 0, charge the card on file on day 5, send another text on day 10, and send physical mail on day 20.
...
- Once a payment is made, Decoda posts this information back to your system.

### **Accept In-Person Payments (coming soon)**

- For in-person payments at the card terminal, there are two options:
  1. Use Decoda to create the charge and then present the charge using Decoda's Web App on the card terminal
- Once a payment is successfully made, Decoda posts this information back to your system.
