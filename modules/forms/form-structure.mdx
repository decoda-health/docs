...
<Info>
  The **Insurance** block type also exists in the system and supports integrated insurance verification through PVerify. However, it is not available in the **Add Section** menu. Insurance blocks appear on forms that were created with them previously or configured through the API.
</Info>
