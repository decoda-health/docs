...
<Info>
  **Prerequisites:** Your clinic must have [memberships configured](/modules/settings/memberships). Only plans with **Show in patient portal** turned on appear here — staff-only plans are hidden, though existing members can still view a plan they're enrolled in.
</Info>
