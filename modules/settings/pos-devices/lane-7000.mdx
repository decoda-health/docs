...
<Steps>
  ...
  <Step title="Register Device">
    The terminal will display a 6-digit alphanumeric code. Use this code when [registering the device](/modules/settings/payment-management#register-a-new-device) in Decoda.
  </Step>
</Steps>
