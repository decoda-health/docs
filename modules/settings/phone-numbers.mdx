...
<AccordionGroup>
  ...
  <Accordion title="Permissions">
    Phone Numbers uses the inbound assistants permissions:

    - **Settings Assistants Inbound Read** -- View the Phone Numbers page and configuration pages.
    - **Settings Assistants Inbound Write** -- Provision, configure, forward, and release numbers, and create or edit ring groups, assistants, and closures.
