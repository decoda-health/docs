...
<Note>
  Ring groups on a phone number can include physical desk phones alongside staff browsers and mobiles. Provision phones in [Settings > Desk Phones](/modules/settings/desk-phones) and follow [Setting Up a Desk Phone](/guides/desk-phone-setup) for the handset configuration.
</Note>
