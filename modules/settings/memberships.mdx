...
<Steps>
  ...
  <Step title="Set Up Payment Method">
    The payment options shown depend on whether the first billing date is today (immediate billing) or in the future (deferred billing). Free memberships skip this step entirely.

    **For immediate billing (first billing date is today):**
