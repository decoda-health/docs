...
<Steps>
  ...
  <Step title="Set Billing Frequency">
    Choose how often the membership bills: Daily, Weekly, Biweekly, Monthly, Quarterly, Every Four Months, Semi-Annually, or Yearly. If you have multiple bank accounts configured, select which **Deposit to** account receives membership payments.
  </Step>
