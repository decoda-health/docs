...
<Info>
  **Prerequisites:** You should have at least one [Category](/modules/settings/categories) created before adding products so you can organize them effectively. Inventory tracking is configured per product on the **Inventory** tab of the product drawer.
</Info>
...
<Steps>
  ...
  <Step title="Adjust Settings">
    ...
    - **Show in Checkout:** Controls whether this product appears in the checkout product search and today's items list. Enabled by default. Turn this off for products you want to keep in your catalog (e.g., for inventory tracking) but not offer for sale during checkout.
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Permissions">
    - **View Inventory** -- Required to view the Products page and product details.
    - **Manage Inventory** -- Required to create, edit, bulk edit, link inventory, and archive products.
