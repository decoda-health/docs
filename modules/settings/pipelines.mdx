...
<AccordionGroup>
  ...
  <Accordion title="Permissions">
    Viewing the Lead Pipelines page is gated by the **Settings Read** permission, and editing pipelines, stages, and automations is gated by **Growth Write**. Permissions are configured under [Users & Roles](/modules/settings/users).
  </Accordion>
