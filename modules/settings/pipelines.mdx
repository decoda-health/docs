...
<AccordionGroup>
  ...
  <Accordion title="Permissions">
    ...
    No granular Roles UI permission gates pipeline editing on its own -- it falls under the broader **Manage Settings** permission. Permissions are configured under [Users & Roles](/modules/settings/users).
  </Accordion>
