...
| Step Type | Purpose |
|-----------|---------|
| **Appointment** | Schedule a visit with configurable services, medications, measurements, and provider notes. |
| **Task** | Assign an action item with a title, description, status, priority, assignee, dates, and provider notes. |
