...
<AccordionGroup>
  ...
  <Accordion title="Permissions">
    ...
    - **Settings Assistants Texting Read / Write** -- View and modify the Texting Assistant and the Web Chat Widget.
    - **Settings Suggestions Read / Write** -- View and modify the reusable text suggestions on the [Suggestions](/modules/settings/suggestions) page.
