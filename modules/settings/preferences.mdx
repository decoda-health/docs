...
Preferences let you tailor how Decoda looks and behaves for you. Choose a color theme, control what you see on the calendar, and adjust how notes and messages are displayed. Google Calendar sync has its own page — see [Google Calendar](/modules/settings/google-calendar).
