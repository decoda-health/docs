...
The Measurements page lets you define the metrics your practice tracks for patients — things like weight, blood pressure, lab results, or custom clinical scores. The page has two tabs: **Groups** and **Fields**.
...
<Steps>
  <Step title="Open Templates">
    Click **Apply Template** at the top of the Groups tab.
  </Step>
  ...
  <Step title="Apply">
    Click **Apply** on the one you want. The group and all its fields are created for you.
  </Step>
</Steps>
...
<Steps>
  <Step title="Start a New Group">
    Click **Create Group** at the top of the Groups tab.
  </Step>
  ...
  <Step title="Set Display Options">
    Under Display Settings, you can turn on or off:
    - **Show change between readings** — Shows how much each value went up or down since the last entry.
    - **Show trend indicators** — Adds arrows next to values to show whether they are going up or down.
    - **Show time of day** — Displays the time a measurement was taken alongside the date. Useful when readings are recorded more than once a day (e.g., morning and evening vitals).
  </Step>
...
- Click on a group's row to open the editor. Update any settings, then click **Save Changes**.
...
- Click on a field's row to open the editor. Update any settings, then click **Save Changes**.
