...
<Info>
  **Email Domain is a separate Settings page**, not a section inside Developer Settings. Go to **Settings > Email Domain** to manage it. It is documented here because it is a developer-oriented setup.
</Info>
