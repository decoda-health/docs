...
<AccordionGroup>
  ...
  <Accordion title="Location-Specific Tax Rates">
    ...
    This is configured under **Settings > Payment Management** in the **Tax Rates** section. Each tax rate has a **Location Scope** that limits which locations it applies to. See [Payment Management](/modules/settings/payment-management#tax-rates) for details.
  </Accordion>
