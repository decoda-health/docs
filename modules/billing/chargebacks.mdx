...
If the dispute is legitimate (e.g., you agree the patient was overcharged or the service wasn't provided), click **Accept Chargeback**. This:
...
Once you've filled in all required evidence items, click **Submit Dispute** to send your response to the card network. After submission:
...
- **Action Required** — A new chargeback needs your response (appears as an action-required alert)
