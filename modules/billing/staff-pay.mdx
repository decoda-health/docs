---
title: 'Staff Pay'
description: 'Review provider earnings — commissions, tips, and hourly pay — for any date range and export reports for payroll.'
---
...
- **Commission details** show the patient name, commission rate, the item sold, the charge total, and the date. Click the patient name to go to their profile. Click the rate to go to the commission rule settings. Click the item name to go to the charge. Items [excluded from commission](/modules/billing/cash-and-commissions#exclude-an-item-from-commission) don't appear here.
