...
You can filter, group, duplicate, and bulk-manage rules from the settings page. See the [Commissions settings guide](/modules/settings/commissions) for full details.
