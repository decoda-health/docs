...
<Info>
  **Where to find Inventory:** In the left sidebar, click **Inventory**. You'll see three tabs: **Stockroom** (your stock items and quantities), **Purchase Orders** (orders to suppliers), and **Suppliers** (your vendor directory).
</Info>
