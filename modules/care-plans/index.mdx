...
A message step sends an automated SMS to the patient. Message steps are typically linked to an appointment and appear on the timeline next to the appointment they belong to.
