...
| **Service Added** | A service was added to the appointment. Shows the service name. |
| **Service Removed** | A service was removed from the appointment. Shows the service name. |
