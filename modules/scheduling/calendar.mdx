...
View presets let you save a group of providers so you can switch between different calendar views with one click. Presets are shared across your organization, so any team member can use them.

To use a preset, click the **View Presets** button in the sidebar. You'll see two sections:

- **Teams:** Any teams configured in your organization appear here. Selecting a team instantly shows only that team's providers on the calendar.
- **Saved Presets:** Custom presets that anyone in your organization has saved. Each preset shows how many providers it includes.

### Save a Preset

1. Select the providers you want on the calendar using the provider filter.
2. Click **View Presets** in the sidebar.
3. Click **Save current selection** at the bottom.
4. Enter a name for the preset and click the save button.

The preset is now available to everyone in your organization.

### Delete a Preset

Hover over a saved preset and click the trash icon to remove it.
