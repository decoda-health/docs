...
<CardGroup cols={2}>
  ...
  <Card title="Care Plans" icon="clipboard-list" href="/modules/patients/care-plans">
    Assign multi-step care plans to patients and track their treatment journey.
  </Card>
  <Card title="Care Plan Steps" icon="list-check" href="/modules/patients/care-plan-steps">
    Understand step statuses, transitions, and how to schedule appointments from steps.
  </Card>
  <Card title="Step Types" icon="sliders" href="/modules/patients/care-plan-step-types">
    Configure appointment and task steps, including repeating steps.
  </Card>
  <Card title="Editing & Progress" icon="chart-line" href="/modules/patients/care-plan-editing">
