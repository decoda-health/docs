...
<CardGroup cols={2}>
  ...
  <Card title="Care Plans" icon="clipboard-list" href="/modules/care-plans">
    Assign multi-step care plans to patients and track their treatment journey.
  </Card>
  <Card title="Care Plan Steps" icon="list-check" href="/modules/care-plans#step-statuses">
    Understand step statuses, transitions, and how to schedule appointments from steps.
  </Card>
  <Card title="Step Types" icon="sliders" href="/modules/care-plans#step-types">
    Configure appointment, task, message, and decision steps.
  </Card>
  <Card title="Editing & Progress" icon="chart-line" href="/modules/care-plans#editing-a-care-plan">
    Make changes to assigned care plans and track patient progress.
  </Card>
</CardGroup>
...
- **Bulk Text** -- shows a note that bulk messaging has moved to [Blasts](/modules/comms/blasts).
- **Tag** -- opens a window listing every tag your organization has created. Pick one or more and click **Add [N] tags** to apply them to every selected patient. This only adds tags; existing tags are kept. Tags are managed under [Settings > General > Manage Patient Tags](/modules/settings/general#manage-patient-tags). To change tags on a single patient, use **Manage Tags** on the patient's **Settings** tab.
...
<Steps>
  ...
  <Step title="Add Optional Fields">
    ...
    You can also expand **Marketing Preferences** to set whether the patient has opted in to **SMS Marketing** and **Email Marketing** at the time of creation.
  </Step>
...
<Steps>
  ...
  <Step title="Update Fields">
    ...
    - **Marketing Preferences** -- toggle SMS Marketing and Email Marketing opt-in
  </Step>
