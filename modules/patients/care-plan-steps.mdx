...
In the step details, a completed step shows the date labeled as **Completed:** followed by the date.
...
These overdue steps need attention — either schedule the appointment, complete the task, or change the step's status.
