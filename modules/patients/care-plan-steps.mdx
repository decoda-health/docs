...
Progress shows how far along a patient is in their care plan — how many steps are completed out of the total (e.g., "3 of 8 steps"). If a step repeats, each iteration counts separately toward the total. For details on how progress is calculated and displayed, see [Progress Tracking](/modules/patients/care-plan-editing#progress-tracking).
