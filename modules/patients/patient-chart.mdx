...
**Marketing Opt-In** -- shows whether the patient has opted in to **SMS Marketing** and **Email Marketing**. These values are read-only and can only be changed by the patient through a form submission.
