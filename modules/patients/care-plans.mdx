...
- **Progress summary** -- shows how many steps are completed out of the total (e.g., "3/6 steps") and a percentage, color-coded by status.
...
- [Care Plan Step Types](/modules/patients/care-plan-step-types) — how to configure appointment and task steps.
