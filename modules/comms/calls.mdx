...
| **From** | Who made the call -- a patient name (linked to their chart), a provider, or an AI assistant (linked to assistant settings). If the call was placed from a [desk phone](/modules/settings/desk-phones), a **Desk phone** badge with the phone's name appears alongside. |
| **To** | Who received the call. Same display as From -- including the **Desk phone** badge if a staff member's desk phone answered. |
...
If the call was on a **shared** desk phone with no staff member attached (a front-desk or exam-room handset), the From or To column shows the phone's display name with a **Desk phone** badge instead of a person's name -- for example, "Front desk · Desk phone".
