---
title: 'Overview'
description: 'Send and receive text messages with patients, manage phone calls, and use AI-suggested responses.'
---
...
<CardGroup cols={2}>
  ...
  <Card title="AI-Suggested Replies" icon="wand-magic-sparkles" href="/modules/comms/ai-responses">
    Review AI-generated responses, give feedback, and execute AI-suggested actions.
  </Card>
...
<AccordionGroup>
  ...
  <Accordion title="Permissions">
    ...
    - **Messaging Chats Write** -- Required to send text messages and manage conversation status (mark as resolved, opt out of texting).
