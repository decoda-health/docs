...
<AccordionGroup>
  ...
  <Accordion title="Meta Ads Integration">
    If you run lead ads on Facebook or Instagram, you can connect Meta so submissions flow into Decoda automatically. Go to **Growth > Settings > Integrations**, find the **Meta Ads** card, and click **Connect**. A popup walks you through signing in to Meta and choosing which Pages, ad accounts, and Instagram accounts to share. When the popup closes, the card lists the connected **Pages** and shows whether each one's lead subscription is active.

    Once connected, every submission from a Meta lead form on those Pages creates a new lead in Decoda, attributed to the matching campaign on the Campaigns page.

    To disconnect, click **Disconnect** on the card and confirm when prompted.
  </Accordion>
