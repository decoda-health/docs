...
- **Tasks Sidebar:** A quick-access panel available from anywhere in the app. Defaults to tasks assigned to you.
- **Tasks Page:** A full dashboard for viewing, filtering, and organizing all tasks across your organization.

### Filtering the Sidebar

By default, the sidebar only shows tasks assigned to you.
- To see tasks assigned to others or unassigned tasks, click the **Filter & Sort** (funnel) icon and select **All tasks** under Filter by Assignee.
