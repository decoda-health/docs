...
The Product Sales Breakdown shows revenue on either a **Cash** or **Accrual** basis. Switch between them with the basis menu at the top of the dashboard.

The short version:

- **Cash** counts a sale on the day **money changes hands**.
- **Accrual** counts a sale on the day **the service (or product) is delivered**.

For a walk-in visit paid at checkout, both bases give the same number — payment and delivery happen at the same moment. They only diverge when patients pay for something now and use it later.

### Where the Two Bases Differ

Here's how each basis counts the common transactions:

| What happened | Under Cash | Under Accrual |
|---|---|---|
| \$80 facial, paid at checkout | \$80 today | \$80 today |
| \$500 10-visit package, paid up front | \$500 today, then \$0 per visit | \$0 at purchase, then \$50 per visit as the patient redeems |
| \$200 monthly membership, billed Feb 1 | \$200 on Feb 1 | \$200 spread evenly across the billing cycle |
| Refund of a past sale | Reduces revenue on the day the refund is processed | Same as Cash — reduces revenue on the day it's processed |
...
At any given moment, Cash will usually be ahead of Accrual. The gap is revenue the clinic has already collected but hasn't yet earned — package visits the patient hasn't taken, membership days still ahead in the cycle. As patients redeem those visits and the membership months tick by, Accrual catches up. Once everything's been delivered, the two bases land on the same total.

### Which One Should You Use?

- **Day-to-day clinic operations:** use **Cash**. It matches what you see in your bank deposits and point-of-sale totals.
- **Financial statements, tax reports, anything for your accountant:** use **Accrual**. It tells you what you've actually *earned*, not just what you've collected. It's also the cleaner basis for month-over-month comparisons, since a big package sale or membership renewal that's still being delivered won't distort the picture.

### Set the Clinic Default

Go to **Settings > General > Analytics** and set **Default Accounting Basis**. That's the basis the dashboard opens in for everyone. Each person can still switch their own basis for the session without affecting anyone else.
