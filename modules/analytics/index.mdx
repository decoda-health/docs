...
- **Compare to previous period** -- Every numeric summary shows a small badge with the change versus the prior comparable period (last week vs. the week before, last month vs. the month before, and so on). A green badge means the number went up; red means it went down. Hover the badge for the exact prior value.
